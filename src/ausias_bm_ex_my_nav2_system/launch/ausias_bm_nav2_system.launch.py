...
def generate_launch_description():
    ...
    project_dir = get_package_share_directory('ausias_bm_ex_my_nav2_system')
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value= os.path.join(get_package_share_directory('ausias_bm_ex_my_world'),'world/burger.model'),
